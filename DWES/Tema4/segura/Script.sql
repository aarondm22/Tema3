...
CREATE TABLE empleados (id_empleado INT, nombre NVARCHAR(50), dni VARCHAR(9), cargo NVARCHAR(50));
CREATE TABLE cargo (id_cargo INT, nombre NVARCHAR(50), descripcion NVARCHAR(100));
...
INSERT INTO productos VALUES (000008, 'Numcias Tales', 69.99);
...
INSERT INTO lugar VALUES (158, 'Calle Zamora N-12 (avila)', 920645236, 5);
INSERT INTO lugar VALUES (054, 'Calle Pascual N-3 (Bilbao)', 963521487, 3);
